...
class AuthController extends Controller
{
    ...
    {
        $result = $this->authService->createEmployee($request->validated());
    ...
    {
        return response()->json(
            $this->authService->createHospitalManager($request->validated())
        );
    }

    public function setPassword(SetPasswordRequest $request)
    {
        $result = $this->authService->setPassword($request->validated());
